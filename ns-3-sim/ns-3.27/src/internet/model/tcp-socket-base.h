...
protected:
  ...
  TracedValue<Time> m_latency;         //!< Last latency sample collected, addition patch!
  TracedValue <SequenceNumber32> m_rxAck; //!< Last Ack No, addition patch!
  TracedCallback<Ptr<const Packet> > m_tcprxTrace;  //!< tcp rx packet trace, addition patch
