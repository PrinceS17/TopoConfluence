      ...
      if (!m_promiscCallback.IsNull ())
        {
          ...
          // my additional patch for ARP in PPP!!!
          Address dest = promiscDestination.IsInvalid()? GetAddress () : promiscDestination;
          m_promiscCallback (this, packet, protocol, GetRemote (), dest, NetDevice::PACKET_HOST);
        }
...
PointToPointNetDevice::NeedsArp (void) const
{
  NS_LOG_FUNCTION (this);
  // return false;
  return useArp;            // my addition for PPP usage in emulation!!!
}
