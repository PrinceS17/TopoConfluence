...
TapBridge::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TapBridge")
    ...
    .AddTraceSource ("TapRx",                                           // addition patch!
                  "Receive packet from tap",
                  MakeTraceSourceAccessor (&TapBridge::m_tapRxTrace),
                  "ns3::Packet::TracedCallback")
    .AddTraceSource ("TapTx",                                           // addition patch!
                  "Send packet to tap",
                  MakeTraceSourceAccessor (&TapBridge::m_tapTxTrace),
                  "ns3::Packet::TracedCallback") 
  ;
  return tid;
}
